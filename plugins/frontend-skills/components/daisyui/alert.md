...
|-------|-------------|----------|
| `alert` | Container element | component |
| `alert-outline` | outline style | style |
| `alert-dash` | dash outline style | style |
| `alert-soft` | soft style | style |
| `alert-info` | info color | color |
| `alert-success` | success color | color |
| `alert-warning` | warning color | color |
| `alert-error` | error color | color |
| `alert-vertical` | Vertical layout, good for mobile | direction |
| `alert-horizontal` | Horizontal layout, good for desktop | direction |
