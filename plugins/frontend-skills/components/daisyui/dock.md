...
|-------|-------------|----------|
| `dock` | Dock | component |
| `dock-label` | Text label for Dock Item | part |
| `dock-active` | Makes the Dock Item look active | modifier |
| `dock-xs` | Extra Small Dock | size |
| `dock-sm` | Small Dock | size |
| `dock-md` | Medium Dock | size |
| `dock-lg` | Large Dock | size |
| `dock-xl` | Extra Large Dock | size |
