...
|-------|-------------|----------|
| `menu` | For <ul> tag | component |
| `menu-title` | styles a <li> as title | part |
| `menu-dropdown` | For the collapsible <ul> if you want to show it using JS | part |
| `menu-dropdown-toggle` | For the toggle to show/hide the menu-dropdown using JS | part |
| `menu-disabled` | For the element inside <li> to look disabled | modifier |
| `menu-active` | For the element inside <li> to look active | modifier |
| `menu-focus` | For the element inside <li> to look focused | modifier |
| `menu-dropdown-show` | Shows the menu-dropdown-toggle and menu-dropdown collapsible submenu using JS | modifier |
| `menu-xs` | Extra small size | size |
| `menu-sm` | Small size | size |
| `menu-md` | Medium size | size |
| `menu-lg` | Large size | size |
| `menu-xl` | Extra large size | size |
| `menu-vertical` | Vertical menu (default) | direction |
| `menu-horizontal` | Horizontal menu | direction |
