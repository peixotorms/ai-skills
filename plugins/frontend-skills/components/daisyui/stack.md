...
|-------|-------------|----------|
| `stack` | Puts the children elements on top of each other | component |
| `stack-top` | Aligns the children elements to the top | modifier |
| `stack-bottom` | Aligns the children elements to the bottom | modifier |
| `stack-start` | Aligns the children elements to the start (horizontally) | modifier |
| `stack-end` | Aligns the children elements to the end (horizontally) | modifier |
