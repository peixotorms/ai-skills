...
|-------|-------------|----------|
| `list` | A vertical flex layout to include list rows | component |
| `list-row` | The item inside list. A horizontal grid layout to include data | component |
| `list-col-wrap` | For one of direct children of list-row to push it to the next line | modifier |
| `list-col-grow` | For one of direct children of list-row to make it fill the remaining space | modifier |
