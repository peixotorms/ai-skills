...
| `modal-box` | The content part | part |
| `modal-action` | Actions part (buttons, etc.) | part |
| `modal-backdrop` | Label that covers the page when modal is open so we can close the modal by clicking outside | part |
| `modal-toggle` | Hidden checkbox that controls the state of modal | part |
| `modal-open` | Keeps the modal open (you can add this class using JS) | modifier |
| `modal-top` | Moves the modal to top | placement |
| `modal-middle` | Moves the modal to middle | placement |
| `modal-bottom` | Moves the modal to bottom | placement |
| `modal-start` | Moves the modal to start horizontally | placement |
| `modal-end` | Moves the modal to end horizontally | placement |
