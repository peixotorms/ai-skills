...
|-------|-------------|----------|
| `kbd` | Do show a keyboard key or a shortcut key | component |
| `kbd-xs` | Extra small size | size |
| `kbd-sm` | Small size | size |
| `kbd-md` | Medium size | size |
| `kbd-lg` | Large size | size |
| `kbd-xl` | Extra large size | size |
