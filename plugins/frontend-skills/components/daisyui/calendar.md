...
|-------|-------------|----------|
| `cally` | for Cally web component | component |
| `pika-single` | for the input field that opens Pikaday calendar | component |
| `react-day-picker` | for the DayPicker component | component |
