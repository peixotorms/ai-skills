...
|-------|-------------|----------|
| `timeline` | Timeline container | component |
| `timeline-start` | The content inside <li> that will be at the start direction | part |
| `timeline-middle` | The content inside <li> that will be at the middle | part |
| `timeline-end` | The content inside <li> that will be at the end direction | part |
| `timeline-snap-icon` | snaps the icon to the start instead of middle | modifier |
| `timeline-box` | Applies a box style to timeline-start or timeline-end | modifier |
| `timeline-compact` | forces all items on one side | modifier |
| `timeline-horizontal` | horizontal layout (default) | direction |
| `timeline-vertical` | vertical layout | direction |
