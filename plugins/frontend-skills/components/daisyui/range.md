...
|-------|-------------|----------|
| `range` | For <input type="range"> tag | component |
| `range-neutral` | neutral color | color |
| `range-primary` | primary color | color |
| `range-secondary` | secondary color | color |
| `range-accent` | accent color | color |
| `range-success` | success color | color |
| `range-warning` | warning color | color |
| `range-info` | info color | color |
| `range-error` | error color | color |
| `range-xs` | Extra small size | size |
| `range-sm` | Small size | size |
| `range-md` | Medium size | size |
| `range-lg` | Large size | size |
| `range-xl` | Extra large size | size |
