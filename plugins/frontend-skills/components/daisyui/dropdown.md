...
|-------|-------------|----------|
| `dropdown` | Dropdown container | component |
| `dropdown-content` | Content part | part |
| `dropdown-start` | Align horizontally to start of button | placement |
| `dropdown-center` | Align horizontally to center of button | placement |
| `dropdown-end` | Align horizontally to end of button | placement |
| `dropdown-top` | Open from top | placement |
| `dropdown-bottom` | Open from bottom | placement |
| `dropdown-left` | Open from left | placement |
| `dropdown-right` | Open from right | placement |
| `dropdown-hover` | Opens on hover too | modifier |
| `dropdown-open` | Force open | modifier |
| `dropdown-close` | Force close | modifier |
