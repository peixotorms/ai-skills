...
|-------|-------------|----------|
| `stats` | Container of multiple stat items | component |
| `stat` | A block to display stat data about a topic | part |
| `stat-title` | Title part | part |
| `stat-value` | Value part | part |
| `stat-desc` | Description part | part |
| `stat-figure` | Figure part for icon, etc | part |
| `stat-actions` | Actions part for button, etc | part |
| `stats-horizontal` | Makes stats horizontal (default) | direction |
| `stats-vertical` | Makes stats vertical | direction |
