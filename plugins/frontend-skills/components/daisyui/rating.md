...
|-------|-------------|----------|
| `rating` | For a div containing radio inputs | component |
| `rating-half` | To shows half of the shapes. Useful for half star ratings | modifier |
| `rating-hidden` | For the first radio to make it hidden so user can clear the rating | modifier |
| `rating-xs` | Extra small size | size |
| `rating-sm` | Small size | size |
| `rating-md` | Medium size | size |
| `rating-lg` | Large size | size |
| `rating-xl` | Extra large size | size |
