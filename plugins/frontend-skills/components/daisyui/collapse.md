...
| `collapse-title` | Title part | part |
| `collapse-content` | Content part | part |
| `collapse-arrow` | Adds arrow icon | modifier |
| `collapse-plus` | Adds plus/minus icon | modifier |
| `collapse-open` | Force open | modifier |
| `collapse-close` | Force close | modifier |
