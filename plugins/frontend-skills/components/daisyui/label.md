...
|-------|-------------|----------|
| `label` | For styling the text next to an input field (or select) | component |
| `floating-label` | For the parent of an input field (or select) and a span that floats above the input field when the field is focused | component |
