...
|-------|-------------|----------|
| `carousel` | Carousel container | component |
| `carousel-item` | Carousel item | part |
| `carousel-start` | Snap elements to start | modifier |
| `carousel-center` | Snap elements to center | modifier |
| `carousel-end` | Snap elements to end | modifier |
| `carousel-horizontal` | Horizontal layout (default) | direction |
| `carousel-vertical` | Vertical layout | direction |
