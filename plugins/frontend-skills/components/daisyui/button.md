...
| `btn-neutral` | neutral color | color |
| `btn-primary` | primary color | color |
| `btn-secondary` | secondary color | color |
| `btn-accent` | accent color | color |
| `btn-info` | info color | color |
| `btn-success` | success color | color |
| `btn-warning` | warning color | color |
| `btn-error` | error color | color |
| `btn-outline` | outline style | style |
| `btn-dash` | dash style | style |
| `btn-soft` | soft style | style |
| `btn-ghost` | ghost style | style |
| `btn-link` | looks like a link | style |
| `btn-active` | looks active | behavior |
| `btn-disabled` | looks disabled | behavior |
| `btn-xs` | Extra small size | size |
| `btn-sm` | Small size | size |
| `btn-md` | Medium size (default) | size |
| `btn-lg` | Large size | size |
| `btn-xl` | Extra large size | size |
| `btn-wide` | more horizontal padding | modifier |
| `btn-block` | Full width | modifier |
| `btn-square` | 1:1 ratio | modifier |
| `btn-circle` | 1:1 ratio with rounded corners | modifier |
