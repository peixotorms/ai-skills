...
| `footer-title` | Title of a footer column | part |
| `footer-center` | Aligns footer content to center | placement |
| `footer-horizontal` | Puts footer columns next to each other horizontally | direction |
| `footer-vertical` | Puts footer columns under each other vertically | direction |
