...
|-------|-------------|----------|
| `swap` | Swap container | component |
| `swap-on` | The child element that should be visible when checkbox is checked or when swap is active | part |
| `swap-off` | The child element that should be visible when checkbox is not checked or when swap is not active | part |
| `swap-indeterminate` | The child element that should be visible when checkbox is indeterminate | part |
| `swap-active` | Activates the swap (no need for checkbox) | modifier |
| `swap-rotate` | Adds rotate effect to swap | style |
| `swap-flip` | Adds flip effect to swap | style |
