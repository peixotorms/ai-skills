...
|-------|-------------|----------|
| `table` | For <table> tag | component |
| `table-zebra` | For <table> to show zebra stripe rows | modifier |
| `table-pin-rows` | For <table> to make all the rows inside <thead> and <tfoot> sticky | modifier |
| `table-pin-cols` | For <table> to make all the <th> columns sticky | modifier |
| `table-xs` | Extra small size | size |
| `table-sm` | Small size | size |
| `table-md` | Medium size | size |
| `table-lg` | Large size | size |
| `table-xl` | Extra large size | size |
