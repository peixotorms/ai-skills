...
| `navbar-start` | For the div inside navbar, to fill 50% of width | part |
| `navbar-center` | For the div inside navbar, to be at center horizontally | part |
| `navbar-end` | For the div inside navbar, to fill second 50% of width | part |
