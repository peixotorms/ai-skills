...
|-------|-------------|----------|
| `card` | Card | component |
| `card-title` | Title part | part |
| `card-body` | Body part (content) | part |
| `card-actions` | Actions part (buttons, etc.) | part |
| `card-border` | Adds border to <card> | style |
| `card-dash` | dash style | style |
| `card-side` | The image in <figure> will be on to the side | modifier |
| `image-full` | The image in <figure> element will be the background | modifier |
| `card-xs` | Extra small size | size |
| `card-sm` | Small size | size |
| `card-md` | Medium size (default) | size |
| `card-lg` | Large size | size |
| `card-xl` | Extra large size | size |
