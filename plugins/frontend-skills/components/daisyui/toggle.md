...
|-------|-------------|----------|
| `toggle` | For <input type="checkbox"> | component |
| `toggle-primary` | primary color | color |
| `toggle-secondary` | secondary color | color |
| `toggle-accent` | accent color | color |
| `toggle-neutral` | neutral color | color |
| `toggle-success` | success color | color |
| `toggle-warning` | warning color | color |
| `toggle-info` | info color | color |
| `toggle-error` | error color | color |
| `toggle-xs` | Extra small size | size |
| `toggle-sm` | Small size | size |
| `toggle-md` | Medium size | size |
| `toggle-lg` | Large size | size |
| `toggle-xl` | Extra large size | size |
