...
|-------|-------------|----------|
| `tabs` | Container of multiple tab items | component |
| `tab` | A single tab button (can be button, link, div, radio input, etc) | part |
| `tab-content` | Tab content that comes immediately after a tab | part |
| `tabs-box` | box style | style |
| `tabs-border` | bottom border style | style |
| `tabs-lift` | lift style | style |
| `tab-active` | Makes a single tab look active | modifier |
| `tab-disabled` | Makes a single tab look disabled | modifier |
| `tabs-top` | Puts tab buttons on top of the tab-content (default) | placement |
| `tabs-bottom` | Puts tabs on under the tab-content | placement |
| `tabs-xs` | Extra small size | size |
| `tabs-sm` | Small size | size |
| `tabs-md` | Medium size | size |
| `tabs-lg` | Large size | size |
| `tabs-xl` | Extra large size | size |
