...
|-------|-------------|----------|
| `badge` | Container element | component |
| `badge-outline` | outline style | style |
| `badge-dash` | dash outline style | style |
| `badge-soft` | soft style | style |
| `badge-ghost` | ghost style | style |
| `badge-neutral` | neutral color | color |
| `badge-primary` | primary color | color |
| `badge-secondary` | secondary color | color |
| `badge-accent` | accent color | color |
| `badge-info` | info color | color |
| `badge-success` | success color | color |
| `badge-warning` | warning color | color |
| `badge-error` | error color | color |
| `badge-xs` | extra small size | size |
| `badge-sm` | small size | size |
| `badge-md` | medium size (default) | size |
| `badge-lg` | large size | size |
| `badge-xl` | extra large size | size |
