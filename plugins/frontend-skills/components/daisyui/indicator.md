...
|-------|-------------|----------|
| `indicator` | Container element | component |
| `indicator-item` | will be placed on the corner of sibling | part |
| `indicator-start` | align horizontally to the start | placement |
| `indicator-center` | align horizontally to the center | placement |
| `indicator-end` | align horizontally to the end | placement |
| `indicator-top` | align vertically to top | placement |
| `indicator-middle` | align vertically to middle | placement |
| `indicator-bottom` | align vertically to bottom | placement |
