...
| `avatar-group` | Container for multiple avatars | component |
| `avatar-online` | shows a green dot as online indicator | modifier |
| `avatar-offline` | shows a gray dot as offline indicator | modifier |
| `avatar-placeholder` | To show letters as avatar placeholder | modifier |
