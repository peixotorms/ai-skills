...
|-------|-------------|----------|
| `drawer` | The wrapper for sidebar and content | component |
| `drawer-toggle` | The hidden checkbox that controls the state of drawer | part |
| `drawer-content` | Content part | part |
| `drawer-side` | Sidebar part | part |
| `drawer-overlay` | Label that covers the page when drawer is open | part |
| `drawer-end` | puts drawer to the other side | placement |
| `drawer-open` | Forces the drawer to be open | modifier |
| `is-drawer-open:` | Applies styles when the drawer is open | variant |
| `is-drawer-close:` | Applies styles when the drawer is closed | variant |
