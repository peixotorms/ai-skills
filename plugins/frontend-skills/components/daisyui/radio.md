...
|-------|-------------|----------|
| `radio` | For radio input | component |
| `radio-neutral` | neutral color | color |
| `radio-primary` | primary color | color |
| `radio-secondary` | secondary color | color |
| `radio-accent` | accent color | color |
| `radio-success` | success color | color |
| `radio-warning` | warning color | color |
| `radio-info` | info color | color |
| `radio-error` | error color | color |
| `radio-xs` | Extra small size | size |
| `radio-sm` | Small size | size |
| `radio-md` | Medium size | size |
| `radio-lg` | Large size | size |
| `radio-xl` | Extra large size | size |
